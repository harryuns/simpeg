				...
				<table style="width: 100%;" class="tabel" cellspacing="0" cellpadding="5" border="0">
					...
					<tr>
						...
						<td><select style="width: 250px;" name="K_PTP">
							<?php echo ShowOption(array( 'Array' => $array_ptp, 'ArrayID' => 'K_ASAL_SK', 'ArrayTitle' => 'CONTENT' )); ?>
						</select></td>
					</tr>
					<tr>
						<td>Pejabat TT</td>
					...
					<tr>
						...
						<td><select style="width: 250px;" name="K_RUMPUN_ILMU">
							<?php echo ShowOption(array( 'Array' => $array_rumpun_ilmu, 'ArrayID' => 'K_ASAL_SK', 'ArrayTitle' => 'CONTENT' )); ?>
						</select></td>
					</tr>
					<tr>
