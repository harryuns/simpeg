<?php
	...
	$ArrayStatusKerja = $this->CI->lstatus_kerja->GetArrayStatusKerja();
?>
...
<div style="float: left; width: 350px;"><select name="K_STATUS_KERJA" style="width: 300px;"><?php echo GetOption(false, $ArrayStatusKerja, ''); ?></select></div>
<div class="clear"></div>