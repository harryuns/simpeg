...
class Report0201 {
    ...
    function BuildExcel($objPHPExcel) {
        ...
        foreach ($objPHPExcel->Report['List'] as $Key => $Element) {
            ...
            $ArrayTotal['JML_LP_0'] = $ArrayTotal['JML_LP_0'] + $ArrayTotal['JML_L_0'] + $ArrayTotal['JML_P_0'];
            ...
            $ArrayTotal['JML_LP_1'] = $ArrayTotal['JML_LP_1'] + $ArrayTotal['JML_L_1'] + $ArrayTotal['JML_P_1'];
            ...
            $ArrayTotal['JML_LP_2'] = $ArrayTotal['JML_LP_2'] + $ArrayTotal['JML_L_2'] + $ArrayTotal['JML_P_2'];
            ...
            $ArrayTotal['JML_LP_3'] = $ArrayTotal['JML_LP_3'] + $ArrayTotal['JML_L_3'] + $ArrayTotal['JML_P_3'];
            ...
            $ArrayTotal['JML_LP_4'] = $ArrayTotal['JML_LP_4'] + $ArrayTotal['JML_L_4'] + $ArrayTotal['JML_P_4'];
        }
        ...
        foreach ($objPHPExcel->Report['List'] as $Key => $Element) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$Row, $Element['JML_L_0']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D'.$Row, $Element['JML_P_0']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E'.$Row, $Element['JML_LP_0']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$Row, $Element['JML_L_1']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$Row, $Element['JML_P_1']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$Row, $Element['JML_LP_1']);
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$Row, $Element['JML_L_3']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$Row, $Element['JML_P_3']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$Row, $Element['JML_LP_3']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$Row, $Element['JML_L_4']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$Row, $Element['JML_P_4']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$Row, $Element['JML_LP_4']);
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$Row, $ArrayTotal['JML_L_0']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D'.$Row, $ArrayTotal['JML_P_0']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E'.$Row, $ArrayTotal['JML_LP_0']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$Row, $ArrayTotal['JML_L_1']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$Row, $ArrayTotal['JML_P_1']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$Row, $ArrayTotal['JML_LP_1']);
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$Row, $ArrayTotal['JML_L_3']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$Row, $ArrayTotal['JML_P_3']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$Row, $ArrayTotal['JML_LP_3']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$Row, $ArrayTotal['JML_L_4']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$Row, $ArrayTotal['JML_P_4']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$Row, $ArrayTotal['JML_LP_4']);
